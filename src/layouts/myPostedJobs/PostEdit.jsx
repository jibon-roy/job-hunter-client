...
const PostEdit = ({ job, index }) => {
    ...
    return (
        <form onSubmit={handleUpdateJob} className="p-2 mb-10">
            <div className="text-2xl font-semibold text-primary-indigo"><span className="text-primary-dark">#Posted Job:</span> {post?.jobTitle} ({index + 1})</div>
            <section className=" body-font relative rounded-lg border hover:border-primary-indigo focus:border-r-primary-indigo active:border-primary-indigo  bg-base-300">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                            <div className="p-2">
                                <div className="relative">
                                    ...
                                    <input type="email" autoComplete="word" id="email" defaultValue={user?.email} disabled name="email" className="w-full bg-neutral-50 input-disabled bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-primary-indigo focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2">
                                <div className="relative">
                                    <label htmlFor="jobTitle" className="leading-7 text-sm ">Job Title</label>
                                    <input type="text" autoCapitalize="sentences" required defaultValue={post?.jobTitle} id="jobTitle" name="jobTitle" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-primary-indigo focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2">
                                <div className="relative">
                            ...
                            <div className="p-2">
                                <div className="relative">
                                    ...
                                    <br />
                                    <select id="category" value={post?.category} name="category" required className="w-full bg-gray-300 rounded border border-gray-300 focus:border-primary-indigo focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" >
                            ...
                            <div className="p-2">
                                <div className="relative">
                                    ...
                                    <input type="number" id="minPrice" defaultValue={post?.minPrice} required name="minPrice" placeholder="Minimum Price $" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-primary-indigo focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2">
                                <div className="relative">
                            ...
                            <div className="p-2 sm:col-span-2">
                                <div className="relative">
                                    ...
                                    <textarea name="jobDescription" id="jobDescription" defaultValue={post?.jobDescription} className="w-full mx-auto bg-gray-300 rounded border border-gray-300 focus:border-primary-indigo focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                            </div>
                            <div className="p-2 w-full flex justify-around items-center">
                                <PrimaryButton>Update</PrimaryButton>
                                <button type="reset" className="text-white btn normal-case hover:bg-red font-medium text-neutral-50 bg-red border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={handleDeletePost}>Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
