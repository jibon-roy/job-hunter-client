...
const BidTable = ({ data, value }) => {
    ...
    return (
        <tr className="hover  hover:text-primary-blue">
            ...
            <td><button disabled={isDisabled} onClick={handleDisabled} className={`${isDisabled ? 'bg-neutral-400 hover:bg-neutral-400' : ''} px-2 py-1 hover:bg-primary-blue-hover bg-primary-blue text-primary-white rounded-md`}>Complete</button></td>
        </tr>
    );
};
