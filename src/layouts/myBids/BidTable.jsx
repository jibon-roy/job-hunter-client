...
const BidTable = ({ data, value }) => {
    ...
    return (
        <tr className="hover  hover:text-primary-indigo">
            ...
            <td><button disabled={isDisabled} onClick={handleDisabled} className={`${isDisabled ? 'bg-neutral-400 hover:bg-neutral-400' : ' hover:bg-primary-indigo-hover bg-primary-indigo'} px-2 py-1 text-primary-white rounded-md`}>Complete</button></td>
        </tr>
    );
};
